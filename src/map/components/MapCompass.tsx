...
export function MapCompass() {
  return (
    ...
    >
      ...
      />
      {/* Inner ring */}
      <circle r={42} fill="none" stroke="var(--map-ink-2)" strokeWidth={0.5} />
      {/* Cross hair */}
      <g stroke="var(--map-ink-2)" strokeWidth={0.4}>
      ...
      <polygon
        ...
        strokeWidth={0.5}
      />
      <polygon points="0,-50 4,-8 0,0 -4,-8" fill="var(--map-ink)" />
      <polygon points="0,50 -4,8 0,0 4,8" fill="var(--map-ink)" />
      <polygon points="-50,0 -8,-4 0,0 -8,4" fill="var(--map-ink)" opacity={0.7} />
      <polygon points="50,0 8,-4 0,0 8,4" fill="var(--map-ink)" opacity={0.7} />
      {/* Cardinal labels */}
      <text
        x={0}
