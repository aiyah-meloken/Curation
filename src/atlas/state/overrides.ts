...
import type { AtlasCard, AtlasDSL, Domain, Topic } from "../types";

const STORAGE_KEY = "atlas-preview-overrides-v1";

export type AtlasOverrides = {
...
export const EMPTY_OVERRIDES: AtlasOverrides = {
  newBigDomains: [],
  newSmallDomains: [],
  cardAssignments: {},
};
 ...
 */
export function applyDslOverrides(base: AtlasDSL, o: AtlasOverrides): AtlasDSL {
 ...
 */
export function smallToBigMap(dsl: AtlasDSL): Map<string, string> {
...
export function serializeForExport(o: AtlasOverrides): string {
